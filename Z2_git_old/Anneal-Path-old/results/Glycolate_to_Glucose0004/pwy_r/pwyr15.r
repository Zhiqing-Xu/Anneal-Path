...
DHE0003 <- DirectedHyperedge(c("Glyoxylate","Aldehyde"), c("Glycolaldehyde"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("Glyceraldehyde"), "EC4.1.2_3")
DHE0005 <- DirectedHyperedge(c("NC(=O)CO"), c("Aldehyde","Formamide"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","Glyceraldehyde","Aldehyde","Glyoxylate","NC(=O)CO","Formamide","Glycolate")
