...
DHE0006 <- DirectedHyperedge(c("Glycolaldehyde"), c("D-Erythrulose"), "EC4.1.2_5")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","D-Threose","D-Erythrulose","Glyceraldehyde","Glyoxylate","Glycolaldehyde","Glycolate")
