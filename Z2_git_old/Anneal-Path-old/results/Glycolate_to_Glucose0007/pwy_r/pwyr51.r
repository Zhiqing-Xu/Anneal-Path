...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glycolate","D-Threose","Aldehyde","Glycolaldehyde","NC(=O)CO","Formamide")
...
save_path<-paste(other.name,"/pathways/pathway","51.png",sep="")
