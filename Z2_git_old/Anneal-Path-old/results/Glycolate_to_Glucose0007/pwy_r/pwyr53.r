...
DHE0002 <- DirectedHyperedge(c("Glycolate"), c("Glyoxylate"), "EC1.1.1_1")
...
DHE0006 <- DirectedHyperedge(c("Glycolate"), c("O=C(CO)OP(=O)(O)O"), "EC2.7.1_0")
DHE0007 <- DirectedHyperedge(c("Glycolate"), c("Glycolaldehyde"), "EC1.2.1_1")
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glycolate","Glycolaldehyde","Glyceraldehyde","O=C(CO)OP(=O)(O)O")
...
save_path<-paste(other.name,"/pathways/pathway","53.png",sep="")
