...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Aldehyde","Glycolaldehyde","Glyceraldehyde","NC(=O)CO","Formamide","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","41.png",sep="")
