...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Hydroxypyruvate","Aldehyde","Glycolaldehyde","Glyceraldehyde","O=C(CO)OP(=O)(O)O","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","105.png",sep="")
