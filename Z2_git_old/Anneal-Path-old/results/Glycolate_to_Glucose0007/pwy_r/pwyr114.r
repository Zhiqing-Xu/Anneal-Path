...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","O=CC(O)C(O)(O)CO","O=CC(O)(O)CO","Glycolaldehyde","Glyceraldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","114.png",sep="")
