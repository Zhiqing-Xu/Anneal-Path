...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","D-Threose","Glyceraldehyde","Aldehyde","Glycolaldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","60.png",sep="")
