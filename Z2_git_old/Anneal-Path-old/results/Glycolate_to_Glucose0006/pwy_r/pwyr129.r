...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","Glyceraldehyde","Aldehyde","Glyoxylate","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","129.png",sep="")
