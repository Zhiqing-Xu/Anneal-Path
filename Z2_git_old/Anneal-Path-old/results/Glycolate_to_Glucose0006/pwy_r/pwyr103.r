...
DHE0005 <- DirectedHyperedge(c("Glycolaldehyde"), c("Hydroxypyruvate"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyoxylate","D-Threose","Hydroxypyruvate","Oxomalonate","Glycolaldehyde","Glycolate")
