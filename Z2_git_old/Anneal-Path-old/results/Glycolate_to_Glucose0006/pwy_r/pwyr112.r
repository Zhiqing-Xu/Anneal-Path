...
DHE0003 <- DirectedHyperedge(c("NC(=O)CO"), c("Aldehyde","Formamide"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyoxylate","D-Threose","NC(=O)CO","Formamide","Glycolaldehyde","Glycolate")
