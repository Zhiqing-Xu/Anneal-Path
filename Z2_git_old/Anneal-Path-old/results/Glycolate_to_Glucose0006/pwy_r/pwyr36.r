...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glyceraldehyde","Glycolaldehyde","3-Dehydro-L-threonate","Hydroxypyruvate","O=C(CO)OP(=O)(O)O","Glycolate")
