...
DHE0005 <- DirectedHyperedge(c("Glycolaldehyde","Glycolate"), c("O=C(CO)C(O)(O)CO"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","D-Threose","O=C(CO)C(O)(O)CO","O=C(O)C(=O)C(O)(O)CO","Glycolaldehyde","Glycolate")
