...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyceraldehyde","Glycolaldehyde","3-Dehydro-L-threonate","2-Hydroxy-3-oxopropanoate","Glyoxylate","Glycolate")
