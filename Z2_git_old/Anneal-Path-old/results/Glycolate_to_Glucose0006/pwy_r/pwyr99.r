...
DHE0002 <- DirectedHyperedge(c("Glyoxylate","D-Threose"), c("D-Xylose"), "EC4.1.2_1")
DHE0003 <- DirectedHyperedge(c("3-Dehydro-L-threonate"), c("Glyoxylate","Hydroxypyruvate"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("3-Dehydro-L-threonate"), "EC4.1.2_3")
DHE0005 <- DirectedHyperedge(c("Glycolaldehyde"), c("Aldehyde","Glyoxylate"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","D-Threose","3-Dehydro-L-threonate","Hydroxypyruvate","Glycolaldehyde","Aldehyde","Glycolate")
