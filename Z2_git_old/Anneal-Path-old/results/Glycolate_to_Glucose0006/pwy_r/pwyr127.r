...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glyceraldehyde","Glycolaldehyde","D-Threose","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","127.png",sep="")
