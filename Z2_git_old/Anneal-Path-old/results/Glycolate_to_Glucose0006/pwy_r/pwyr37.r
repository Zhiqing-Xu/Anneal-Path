...
DHE0003 <- DirectedHyperedge(c("Glycolaldehyde"), c("Aldehyde","Glyoxylate"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("O=C(CO)OP(=O)(O)O"), c("Glycolaldehyde"), "EC1.2.1_0")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyoxylate","D-Threose","Glycolaldehyde","O=C(CO)OP(=O)(O)O","Glycolate")
