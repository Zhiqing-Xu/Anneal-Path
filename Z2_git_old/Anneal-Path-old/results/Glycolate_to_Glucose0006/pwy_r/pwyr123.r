...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glyceraldehyde","Glycolaldehyde","2-Hydroxy-3-oxopropanoate","Aldehyde","O=C(CO)OP(=O)(O)O","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","123.png",sep="")
