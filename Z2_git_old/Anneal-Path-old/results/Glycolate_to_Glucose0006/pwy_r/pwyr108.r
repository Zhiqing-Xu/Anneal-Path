...
DHE0002 <- DirectedHyperedge(c("D-Erythrulose"), c("Glycolaldehyde","Hydroxypyruvate"), "EC4.1.2_1")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","D-Erythrulose","Hydroxypyruvate","Aldehyde","Glyceraldehyde","Glyoxylate","Glycolate")
