...
edgeData(testrabph, c("F16bP", "EC4.1.2"), c("EC4.1.2", "GA3P"), "color") <- "firebrick"
edgeData(testrabph, c("F16bP", "EC4.1.2"), c("EC4.1.2", "DHAP"), "color") <- "firebrick"

edgeData(testrabph, c("F6P", "EC2.2.1"), c("EC2.2.1", "X5P"), "lwd") <- c("3", "3")
edgeData(testrabph, c("GA3P", "EC2.2.1"), c("EC2.2.1", "E4P"), "lwd") <- c("3", "3")
edgeData(testrabph, c("F6P", "EC2.2.1"), c("EC2.2.1", "X5P"), "color") <- "firebrick"
edgeData(testrabph, c("GA3P", "EC2.2.1"), c("EC2.2.1", "E4P"), "color") <- "firebrick"
...
edgeData(testrabph, c("PEP", "EC2.5.1"), c("EC2.5.1", "DAHP"), "color") <- "firebrick"
edgeData(testrabph, c("E4P", "EC2.5.1"), c("EC2.5.1", "DAHP"), "lwd") <- c("3", "3")
edgeData(testrabph, c("E4P", "EC2.5.1"), c("EC2.5.1", "DAHP"), "color") <- "firebrick"
