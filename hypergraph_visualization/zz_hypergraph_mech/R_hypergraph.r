...
edgeData(testrabph, c("F16bP", "EC4.1.2"), c("EC4.1.2", "GA3P"), "color") <- "darkgoldenrod4"
edgeData(testrabph, c("F16bP", "EC4.1.2"), c("EC4.1.2", "DHAP"), "color") <- "darkgoldenrod4"

edgeData(testrabph, c("F6P", "EC2.2.1"), c("EC2.2.1", "X5P"), "lwd") <- c("3", "3")
edgeData(testrabph, c("GA3P", "EC2.2.1"), c("EC2.2.1", "E4P"), "lwd") <- c("3", "3")
edgeData(testrabph, c("F6P", "EC2.2.1"), c("EC2.2.1", "X5P"), "color") <- "chartreuse3"
edgeData(testrabph, c("GA3P", "EC2.2.1"), c("EC2.2.1", "E4P"), "color") <- "chartreuse3"
edgeData(testrabph, c("GA3P", "EC1.2.1"), c("EC1.2.1", "3PG"), "lwd") <- c("3", "3")
edgeData(testrabph, c("GA3P", "EC1.2.1"), c("EC1.2.1", "3PG"), "color") <- "chartreuse3"

edgeData(testrabph, c("3PG", "EC5.4.2"), c("EC5.4.2", "2PG"), "lwd") <- c("3", "3")
edgeData(testrabph, c("3PG", "EC5.4.2"), c("EC5.4.2", "2PG"), "color") <- "darkblue"

edgeData(testrabph, c("2PG", "EC4.2.1"), c("EC4.2.1", "PEP"), "lwd") <- c("3", "3")
edgeData(testrabph, c("2PG", "EC4.2.1"), c("EC4.2.1", "PEP"), "color") <- "purple"

edgeData(testrabph, c("PEP", "EC2.5.1"), c("EC2.5.1", "DAHP"), "lwd") <- c("3", "3")
edgeData(testrabph, c("PEP", "EC2.5.1"), c("EC2.5.1", "DAHP"), "color") <- "black"
edgeData(testrabph, c("E4P", "EC2.5.1"), c("EC2.5.1", "DAHP"), "lwd") <- c("3", "3")
edgeData(testrabph, c("E4P", "EC2.5.1"), c("EC2.5.1", "DAHP"), "color") <- "black"
...
nodeData(testrabph, c("F16bP"), "color") <- "firebrick"
nodeData(testrabph, c("F16bP"), "margin") <- 'unit(0, "mm")'

nodeData(testrabph, c("DHAP"), "color") <- "darkgoldenrod4"
nodeData(testrabph, c("DHAP"), "margin") <- 'unit(0, "mm")'
nodeData(testrabph, c("GA3P"), "color") <- "darkgoldenrod4"
nodeData(testrabph, c("GA3P"), "margin") <- 'unit(0, "mm")'

nodeData(testrabph, c("X5P"), "color") <- "chartreuse3"
nodeData(testrabph, c("X5P"), "margin") <- 'unit(2, "mm")'
nodeData(testrabph, c("E4P"), "color") <- "chartreuse3"
nodeData(testrabph, c("E4P"), "margin") <- 'unit(2, "mm")'
nodeData(testrabph, c("3PG"), "color") <- "chartreuse3"
nodeData(testrabph, c("3PG"), "margin") <- 'unit(2, "mm")'

nodeData(testrabph, c("2PG"), "color") <- "darkblue"
nodeData(testrabph, c("2PG"), "margin") <- 'unit(2, "mm")'

nodeData(testrabph, c("PEP"), "color") <- "purple"
nodeData(testrabph, c("PEP"), "margin") <- 'unit(2, "mm")'

nodeData(testrabph, c("DAHP"), "color") <- "black"
nodeData(testrabph, c("DAHP"), "margin") <- 'unit(0, "mm")'
