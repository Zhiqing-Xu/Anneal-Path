...
DHE0008 <- DirectedHyperedge(c("NC(=O)CC(N)CC(=O)O"), c("3-Aminopentanedioate"), "EC3.5.1_0")
DHE0009 <- DirectedHyperedge(c("Glutamine"), c("NC(=O)CC(N)CC(=O)O"), "EC5.4.3_0")
Cnodes <- c("C=C(C)CC=O","C=C(C)CCO","Mevaldate","Acetaldehyde","Acetoacetate","CC(N)CC(=O)O","NC(=O)CC(=O)CC=O","NC(=O)CC(=O)O","NC(=O)CC(N)CC=O","3-Aminopentanedioate","HCO3-","NC(=O)CC(N)CC(=O)O","Glutamine")
