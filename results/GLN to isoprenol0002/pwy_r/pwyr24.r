...
DHE0006 <- DirectedHyperedge(c("NC(=O)CC(=O)CC(=O)O"), c("3-Oxobutanamide"), "EC4.1.2_1")
DHE0007 <- DirectedHyperedge(c("NC(=O)CC(N)CC(=O)O"), c("NC(=O)CC(=O)CC(=O)O"), "EC1.4.1_0")
DHE0008 <- DirectedHyperedge(c("Glutamine"), c("NC(=O)CC(N)CC(=O)O"), "EC5.4.3_0")
Cnodes <- c("C=C(C)CC=O","C=C(C)CCO","Mevaldate","Acetaldehyde","Acetoacetate","3-Oxobutanamide","NC(=O)CC(=O)CC=O","NC(=O)CC(=O)O","NC(=O)CC(=O)CC(=O)O","NC(=O)CC(N)CC(=O)O","Glutamine")
