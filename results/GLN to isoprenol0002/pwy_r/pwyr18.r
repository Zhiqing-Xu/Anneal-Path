...
Cnodes <- c("(S)-Mevalonate","C=C(C)CCO","Mevaldate","Acetaldehyde","Acetoacetate","CC(N)CC(=O)O","NC(=O)CC(=O)CC=O","NC(=O)CC(=O)O","NC(=O)CC(N)CC=O","4-Aminobutanoate","NC(=O)CC(N)CC(=O)O","Glutamate","Glutamine")
