...
Cnodes <- c("(S)-Mevalonate","C=C(C)CCO","Mevaldate","Acetaldehyde","Acetoacetate","3-Oxobutanamide","NC(=O)CC(=O)CC=O","NC(=O)CC(=O)O","NC(=O)CC(=O)CC(=O)O","HCO3-","NC(=O)CC(N)CC(=O)O","Glutamine")
