...
Cnodes <- c("C=C(C)CC=O","C=C(C)CCO","Mevaldate","Acetaldehyde","Acetoacetate","CC(N)CC(=O)O","NC(=O)CC(=O)CC=O","NC(=O)CC(=O)O","NC(=O)CC(=O)CC(=O)O","NC(=O)CC(N)CC(=O)O","Carbamate","Glutamine")
