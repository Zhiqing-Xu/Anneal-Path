...
DHE0002 <- DirectedHyperedge(c("Glyoxylate"), c("Aldehyde"), "EC4.1.2_1")
DHE0003 <- DirectedHyperedge(c("Glyoxylate"), c("Glycine"), "EC1.4.1_0")
DHE0004 <- DirectedHyperedge(c("D-Threose 4-phosphate"), c("Glyoxylate","Glyceraldehyde 3-phosphate"), "EC4.1.2_2")
DHE0005 <- DirectedHyperedge(c("D-Allose 6-phosphate"), c("D-Threose 4-phosphate","Glycolaldehyde"), "EC4.1.2_3")
DHE0006 <- DirectedHyperedge(c("D-Glucose 6-phosphate"), c("D-Allose 6-phosphate"), "EC1.1.1_0")
Cnodes <- c("Serine","Pyruvate","Aldehyde","Glycine","Glyoxylate","D-Threose 4-phosphate","Glyceraldehyde 3-phosphate","D-Allose 6-phosphate","Glycolaldehyde","D-Glucose 6-phosphate")
