...
DHE0002 <- DirectedHyperedge(c("D-Allose 6-phosphate"), c("Aldehyde","D-Xylose-5-phosphate"), "EC4.1.2_1")
...
Cnodes <- c("Serine","Pyruvate","Aldehyde","Glycine","D-Allose 6-phosphate","D-Xylose-5-phosphate","Glyoxylate","D-Glucose 6-phosphate")
