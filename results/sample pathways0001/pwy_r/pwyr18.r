...
DHE0004 <- DirectedHyperedge(c("D-Xylose-5-phosphate"), c("Glyoxylate","D-Threose 4-phosphate"), "EC4.1.2_2")
...
Cnodes <- c("Serine","Pyruvate","Aldehyde","Glycine","Glyoxylate","D-Xylose-5-phosphate","D-Threose 4-phosphate","D-Allose 6-phosphate","D-Glucose 6-phosphate")
