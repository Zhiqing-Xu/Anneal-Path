...
DHE0002 <- DirectedHyperedge(c("Glycolaldehyde"), c("Aldehyde"), "EC4.1.2_1")
DHE0003 <- DirectedHyperedge(c("Glyoxylate"), c("Glycine"), "EC1.4.1_0")
DHE0004 <- DirectedHyperedge(c("D-Allose 6-phosphate"), c("D-Threose 4-phosphate","Glycolaldehyde"), "EC4.1.2_2")
...
Cnodes <- c("Serine","Pyruvate","Aldehyde","Glycine","Glycolaldehyde","Glyoxylate","D-Allose 6-phosphate","D-Threose 4-phosphate","D-Xylose-5-phosphate","D-Glucose 6-phosphate")
