...
DHE0002 <- DirectedHyperedge(c("D-Threose 4-phosphate"), c("Aldehyde","Glyceraldehyde 3-phosphate"), "EC4.1.2_1")
...
Cnodes <- c("Serine","Pyruvate","Aldehyde","Glycine","D-Threose 4-phosphate","Glyceraldehyde 3-phosphate","Glyoxylate","D-Allose 6-phosphate","D-Xylose-5-phosphate","Glycolaldehyde","D-Glucose 6-phosphate")
