...
DHE0002 <- DirectedHyperedge(c("D-Xylose-5-phosphate"), c("Aldehyde","D-Threose 4-phosphate"), "EC4.1.2_1")
DHE0003 <- DirectedHyperedge(c("Glyoxylate"), c("Glycine"), "EC1.4.1_0")
DHE0004 <- DirectedHyperedge(c("D-Allose 6-phosphate"), c("Aldehyde","D-Xylose-5-phosphate"), "EC4.1.2_2")
DHE0005 <- DirectedHyperedge(c("D-Allose 6-phosphate"), c("Glyoxylate","D-Xylose-5-phosphate"), "EC4.1.2_3")
DHE0006 <- DirectedHyperedge(c("D-Glucose 6-phosphate"), c("D-Allose 6-phosphate"), "EC1.1.1_0")
Cnodes <- c("Serine","Pyruvate","Aldehyde","Glycine","D-Xylose-5-phosphate","D-Threose 4-phosphate","Glyoxylate","D-Allose 6-phosphate","D-Glucose 6-phosphate")
