...
DHE0005 <- DirectedHyperedge(c("Glycolaldehyde"), c("Aldehyde","Glyoxylate"), "EC4.1.2_3")
DHE0006 <- DirectedHyperedge(c("D-Glucose 6-phosphate"), c("D-Allose 6-phosphate"), "EC1.1.1_0")
Cnodes <- c("Serine","Pyruvate","Aldehyde","Glycine","Glycolaldehyde","Glyoxylate","D-Allose 6-phosphate","D-Threose 4-phosphate","D-Glucose 6-phosphate")
