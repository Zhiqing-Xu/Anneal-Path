...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","O=C(O)C(=O)C(O)CO","Oxomalonate","Glyceraldehyde","Aldehyde","Glyoxylate","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","8.png",sep="")
