...
DHE0003 <- DirectedHyperedge(c("Glyceraldehyde","Glyoxylate"), c("D-Threose"), "EC4.1.2_2")
...
DHE0006 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("O=C(O)C(=O)C(O)CO"), "EC4.1.2_5")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","O=C(O)C(=O)C(O)CO","Oxomalonate","Glyceraldehyde","Glyoxylate","Aldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","12.png",sep="")
