...
DHE0006 <- DirectedHyperedge(c("Glyoxylate"), c("Aldehyde"), "EC4.1.2_3")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","2-Oxoaldehyde","Glyceraldehyde","Aldehyde","Glyoxylate","Glycolate")
