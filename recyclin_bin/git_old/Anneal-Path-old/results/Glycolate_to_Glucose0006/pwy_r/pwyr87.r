...
DHE0003 <- DirectedHyperedge(c("D-Erythrulose"), c("Aldehyde","Glyceraldehyde"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyoxylate","D-Threose","D-Erythrulose","Glyceraldehyde","Glycolaldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","87.png",sep="")
