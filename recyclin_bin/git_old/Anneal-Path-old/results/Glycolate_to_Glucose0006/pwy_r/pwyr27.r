...
DHE0002 <- DirectedHyperedge(c("Glyceraldehyde"), c("Aldehyde","Glycolaldehyde"), "EC4.1.2_1")
DHE0003 <- DirectedHyperedge(c("Aldehyde","Glyceraldehyde"), c("D-Threose"), "EC4.1.2_2")
