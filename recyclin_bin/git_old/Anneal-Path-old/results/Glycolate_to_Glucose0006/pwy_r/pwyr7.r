...
DHE0003 <- DirectedHyperedge(c("Hydroxypyruvate"), c("Aldehyde","Oxomalonate"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glycolate"), c("Glyoxylate"), "EC1.1.1_1")
DHE0005 <- DirectedHyperedge(c("Glycolaldehyde"), c("Hydroxypyruvate"), "EC4.1.2_3")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyoxylate","D-Threose","Hydroxypyruvate","Oxomalonate","Glycolate","Glycolaldehyde")
