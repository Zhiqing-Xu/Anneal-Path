...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyceraldehyde","Glycolaldehyde","O=C(CO)C(O)(O)CO","O=C(O)C(=O)C(O)(O)CO","Glyoxylate","O=C(CO)OP(=O)(O)O","Glycolate")
