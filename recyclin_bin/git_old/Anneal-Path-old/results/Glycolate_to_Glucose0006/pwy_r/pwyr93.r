...
DHE0004 <- DirectedHyperedge(c("Glycolaldehyde"), c("Aldehyde"), "EC4.1.2_3")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Aldehyde","D-Threose","3-Dehydro-L-threonate","Hydroxypyruvate","Glycolaldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","93.png",sep="")
