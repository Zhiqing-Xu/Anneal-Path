...
DHE0003 <- DirectedHyperedge(c("2-Hydroxy-3-oxosuccinate"), c("Glyoxylate","Oxomalonate"), "EC4.1.2_2")
...
DHE0006 <- DirectedHyperedge(c("Glyoxylate"), c("2-Hydroxy-3-oxosuccinate"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glyceraldehyde","Glycolaldehyde","2-Hydroxy-3-oxosuccinate","Oxomalonate","O=C(CO)OP(=O)(O)O","Glycolate")
