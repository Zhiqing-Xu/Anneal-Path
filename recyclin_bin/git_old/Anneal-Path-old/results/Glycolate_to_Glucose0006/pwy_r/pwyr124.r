...
DHE0004 <- DirectedHyperedge(c("Glycolaldehyde"), c("2-Oxoaldehyde"), "EC1.1.1_1")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glyceraldehyde","Glycolaldehyde","2-Oxoaldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","124.png",sep="")
