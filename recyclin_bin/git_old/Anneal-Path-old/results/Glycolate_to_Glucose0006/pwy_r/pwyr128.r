...
DHE0004 <- DirectedHyperedge(c("Glycolate"), c("Glycolaldehyde"), "EC1.2.1_0")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","Aldehyde","Glycolate","NC(=O)CO","Formamide")
...
save_path<-paste(other.name,"/pathways/pathway","128.png",sep="")
