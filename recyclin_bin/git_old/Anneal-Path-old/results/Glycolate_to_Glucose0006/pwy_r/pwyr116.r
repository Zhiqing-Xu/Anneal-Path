...
DHE0004 <- DirectedHyperedge(c("Glycolaldehyde"), c("Aldehyde","Glyoxylate"), "EC4.1.2_3")
DHE0005 <- DirectedHyperedge(c("Glycolaldehyde"), c("2-Hydroxy-3-oxopropanoate"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","D-Threose","2-Hydroxy-3-oxopropanoate","Glycolaldehyde","Aldehyde","Glycolate")
