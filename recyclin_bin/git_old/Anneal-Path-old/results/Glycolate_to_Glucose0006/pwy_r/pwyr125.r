...
DHE0002 <- DirectedHyperedge(c("Aldehyde"), c("Glycolaldehyde"), "EC4.1.2_1")
DHE0003 <- DirectedHyperedge(c("Glycolaldehyde"), c("D-Threose"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","Aldehyde","O=C(CO)OP(=O)(O)O","NC(=O)CO","Formamide","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","125.png",sep="")
