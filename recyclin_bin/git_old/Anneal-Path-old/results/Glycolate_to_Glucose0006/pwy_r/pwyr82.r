...
DHE0003 <- DirectedHyperedge(c("Aldehyde"), c("Glyoxylate"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","D-Threose","Aldehyde","Glycolaldehyde","Glycolate")
