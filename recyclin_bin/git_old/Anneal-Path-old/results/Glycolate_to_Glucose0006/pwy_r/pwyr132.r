...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyceraldehyde","Glycolaldehyde","D-Erythrulose","Glyoxylate","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","132.png",sep="")
