...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyceraldehyde","Glycolaldehyde","NC(=O)CO","Formamide","Glyoxylate","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","131.png",sep="")
