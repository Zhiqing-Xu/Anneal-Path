...
DHE0003 <- DirectedHyperedge(c("Glycolate"), c("Glyoxylate"), "EC1.1.1_1")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","D-Threose","Glycolate","Glycolaldehyde","Aldehyde")
...
save_path<-paste(other.name,"/pathways/pathway","35.png",sep="")
