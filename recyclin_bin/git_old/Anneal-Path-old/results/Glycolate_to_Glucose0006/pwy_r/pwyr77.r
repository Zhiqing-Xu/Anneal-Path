...
DHE0003 <- DirectedHyperedge(c("Glyoxylate","Glyceraldehyde"), c("D-Threose"), "EC4.1.2_1")
...
DHE0006 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("Glyceraldehyde"), "EC4.1.2_3")
DHE0007 <- DirectedHyperedge(c("Glycolate"), c("Glycolaldehyde"), "EC1.2.1_0")
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","2-Hydroxy-3-oxopropanoate","HCO3-","Glyoxylate","Glyceraldehyde","Glycolate")
