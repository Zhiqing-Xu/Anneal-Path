...
DHE0003 <- DirectedHyperedge(c("D-Threose"), c("Erythritol"), "EC1.1.1_1")
DHE0004 <- DirectedHyperedge(c("Glycolaldehyde","Glycolate"), c("O=C(CO)C(O)(O)CO"), "EC4.1.2_0")
DHE0005 <- DirectedHyperedge(c("Glycolaldehyde"), c("D-Threose"), "EC4.1.2_1")
DHE0006 <- DirectedHyperedge(c("Glycolate"), c("Glycolaldehyde"), "EC1.2.1_0")
Cnodes <- c("D-Fructose","D-Glucose","Erythritol","OCC(O)C(O)(O)CO","O=C(CO)C(O)(O)CO","D-Threose","Glycolaldehyde","Glycolate")
