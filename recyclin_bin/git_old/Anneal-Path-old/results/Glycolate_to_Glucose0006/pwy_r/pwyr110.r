...
DHE0003 <- DirectedHyperedge(c("O=C(CO)C(O)(O)CO"), c("Aldehyde","O=C(O)C(=O)C(O)(O)CO"), "EC4.1.2_2")
...
DHE0006 <- DirectedHyperedge(c("Glycolaldehyde","Glycolate"), c("O=C(CO)C(O)(O)CO"), "EC4.1.2_4")
DHE0007 <- DirectedHyperedge(c("Glycolate"), c("Glyoxylate"), "EC1.1.1_1")
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyceraldehyde","Glycolaldehyde","O=C(CO)C(O)(O)CO","O=C(O)C(=O)C(O)(O)CO","Glyoxylate","Glycolate")
