...
DHE0003 <- DirectedHyperedge(c("3-Dehydro-L-threonate"), c("Aldehyde","2-Hydroxy-3-oxopropanoate"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyceraldehyde","Glycolaldehyde","3-Dehydro-L-threonate","2-Hydroxy-3-oxopropanoate","Glyoxylate","O=C(CO)OP(=O)(O)O","Glycolate")
