...
DHE0002 <- DirectedHyperedge(c("2-Hydroxy-3-oxopropanoate"), c("HCO3-","Glycolaldehyde"), "EC6.4.1_0")
DHE0003 <- DirectedHyperedge(c("Aldehyde","Glyceraldehyde"), c("D-Threose"), "EC4.1.2_1")
DHE0004 <- DirectedHyperedge(c("Glycolaldehyde"), c("Aldehyde","Glyoxylate"), "EC4.1.2_2")
DHE0005 <- DirectedHyperedge(c("Glyoxylate"), c("2-Hydroxy-3-oxopropanoate"), "EC4.1.2_3")
DHE0006 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("Glyceraldehyde"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","2-Hydroxy-3-oxopropanoate","HCO3-","Aldehyde","Glyceraldehyde","Glyoxylate","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","122.png",sep="")
