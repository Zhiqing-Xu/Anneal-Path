...
DHE0003 <- DirectedHyperedge(c("D-Threose"), c("Glyoxylate","Glyceraldehyde"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","D-Threose","Glyceraldehyde","Glycolate","Glycolaldehyde")
