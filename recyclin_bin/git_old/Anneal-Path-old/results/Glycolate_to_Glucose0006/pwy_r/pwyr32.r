...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyceraldehyde","Glycolaldehyde","Ethanolamine","Methylamine","Glyoxylate","O=C(CO)OP(=O)(O)O","Glycolate")
