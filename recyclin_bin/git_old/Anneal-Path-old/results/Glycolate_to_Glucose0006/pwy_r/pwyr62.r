...
DHE0002 <- DirectedHyperedge(c("2-Hydroxy-3-oxopropanoate"), c("Glycolaldehyde"), "EC4.1.1_0")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","2-Hydroxy-3-oxopropanoate","Glyoxylate","O=C(CO)OP(=O)(O)O","Glycolate")
