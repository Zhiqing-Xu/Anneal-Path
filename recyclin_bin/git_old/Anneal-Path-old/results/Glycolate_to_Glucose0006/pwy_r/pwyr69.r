...
DHE0002 <- DirectedHyperedge(c("Aldehyde","Glyoxylate"), c("Glycolaldehyde"), "EC4.1.2_1")
DHE0003 <- DirectedHyperedge(c("Glyoxylate","Glyceraldehyde"), c("D-Threose"), "EC4.1.2_2")
...
DHE0006 <- DirectedHyperedge(c("NC(=O)CO"), c("Aldehyde","Formamide"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","Aldehyde","Glyoxylate","Glyceraldehyde","Glycolate","NC(=O)CO","Formamide")
