...
DHE0003 <- DirectedHyperedge(c("Oxomalonate"), c("Glyoxylate","HCO3-"), "EC6.4.1_0")
...
DHE0006 <- DirectedHyperedge(c("Glycolaldehyde"), c("D-Threose"), "EC4.1.2_3")
DHE0007 <- DirectedHyperedge(c("Glycolate"), c("Glycolaldehyde"), "EC1.2.1_0")
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","D-Threose","Oxomalonate","HCO3-","Glycolate","Glycolaldehyde")
...
save_path<-paste(other.name,"/pathways/pathway","120.png",sep="")
