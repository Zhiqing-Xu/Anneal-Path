...
DHE0003 <- DirectedHyperedge(c("D-Erythrulose"), c("Aldehyde","O=C(O)C(=O)C(O)CO"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glycolaldehyde"), c("D-Erythrulose"), "EC4.1.2_3")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyoxylate","D-Threose","D-Erythrulose","O=C(O)C(=O)C(O)CO","Glycolaldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","81.png",sep="")
