...
DHE0003 <- DirectedHyperedge(c("O=C(CO)C(O)(O)CO"), c("Aldehyde","O=C(CO)C(O)O"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glycolate"), c("Glyoxylate"), "EC1.1.1_1")
DHE0005 <- DirectedHyperedge(c("Glycolaldehyde","Glycolate"), c("O=C(CO)C(O)(O)CO"), "EC4.1.2_3")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","Glyoxylate","D-Threose","O=C(CO)C(O)(O)CO","O=C(CO)C(O)O","Glycolate","Glycolaldehyde")
