...
DHE0003 <- DirectedHyperedge(c("2-Hydroxy-3-oxopropanoate"), c("HCO3-","Glycolaldehyde"), "EC6.4.1_0")
DHE0004 <- DirectedHyperedge(c("Glycolaldehyde"), c("2-Hydroxy-3-oxopropanoate"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","Glyceraldehyde","Aldehyde","2-Hydroxy-3-oxopropanoate","HCO3-","Glyoxylate","Glycolate")
