...
DHE0002 <- DirectedHyperedge(c("Glyoxylate","Glyceraldehyde"), c("D-Threose"), "EC4.1.2_1")
DHE0003 <- DirectedHyperedge(c("2-Hydroxy-3-oxopropanoate"), c("Glycolaldehyde"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glyoxylate"), c("2-Hydroxy-3-oxopropanoate"), "EC4.1.2_3")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","Glyoxylate","Glyceraldehyde","2-Hydroxy-3-oxopropanoate","Glycolate")
