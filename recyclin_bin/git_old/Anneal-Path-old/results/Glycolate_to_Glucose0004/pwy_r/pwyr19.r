...
DHE0003 <- DirectedHyperedge(c("Ethanolamine"), c("Methylamine","Aldehyde"), "EC4.1.2_2")
...
DHE0006 <- DirectedHyperedge(c("Glycolaldehyde"), c("Ethanolamine"), "EC1.4.1_0")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","D-Threose","Ethanolamine","Methylamine","Glyoxylate","Glycolaldehyde","Glycolate")
