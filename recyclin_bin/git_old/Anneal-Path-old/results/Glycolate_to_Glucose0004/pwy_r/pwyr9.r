...
DHE0003 <- DirectedHyperedge(c("O=C(CO)C(O)(O)CO"), c("O=C(O)C(=O)C(O)(O)CO","Aldehyde"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glycolaldehyde","Glycolate"), c("O=C(CO)C(O)(O)CO"), "EC4.1.2_3")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","D-Threose","O=C(CO)C(O)(O)CO","O=C(O)C(=O)C(O)(O)CO","Glycolaldehyde","Glycolate","Glyoxylate")
