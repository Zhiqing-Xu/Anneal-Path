...
DHE0003 <- DirectedHyperedge(c("Glycolaldehyde"), c("Aldehyde"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Aldehyde","D-Xylose","D-Threose","Glycolaldehyde","O=C(CO)OP(=O)(O)O","Glycolate")
