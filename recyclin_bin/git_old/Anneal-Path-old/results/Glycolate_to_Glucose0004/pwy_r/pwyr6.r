...
DHE0003 <- DirectedHyperedge(c("Glycolaldehyde"), c("Glyoxylate","Aldehyde"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","D-Threose","Aldehyde","Glycolaldehyde","O=C(CO)OP(=O)(O)O","Glycolate")
