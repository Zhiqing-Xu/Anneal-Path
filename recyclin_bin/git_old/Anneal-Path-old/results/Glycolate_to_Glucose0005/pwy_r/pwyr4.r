...
DHE0003 <- DirectedHyperedge(c("3-Dehydro-L-threonate"), c("2-Hydroxy-3-oxopropanoate","Aldehyde"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Xylose","Aldehyde","D-Threose","3-Dehydro-L-threonate","2-Hydroxy-3-oxopropanoate","Glyoxylate","Glycolaldehyde","Glycolate")
