...
DHE0003 <- DirectedHyperedge(c("D-Erythrulose"), c("O=C(O)C(=O)C(O)CO","Aldehyde"), "EC4.1.2_2")
...
DHE0006 <- DirectedHyperedge(c("Glycolaldehyde"), c("D-Erythrulose"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Xylose","Aldehyde","Glycolaldehyde","Glyceraldehyde","D-Erythrulose","O=C(O)C(=O)C(O)CO","Glyoxylate","O=C(CO)OP(=O)(O)O","Glycolate")
