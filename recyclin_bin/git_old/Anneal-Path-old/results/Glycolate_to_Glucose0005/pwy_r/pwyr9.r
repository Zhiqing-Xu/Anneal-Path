...
DHE0003 <- DirectedHyperedge(c("D-Threose"), c("Aldehyde","Glyceraldehyde"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Xylose","Aldehyde","Glycolaldehyde","Glyceraldehyde","D-Threose","Glyoxylate","O=C(CO)OP(=O)(O)O","Glycolate")
