...
DHE0003 <- DirectedHyperedge(c("Hydroxypyruvate"), c("Oxomalonate","Aldehyde"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Xylose","Aldehyde","D-Threose","Hydroxypyruvate","Oxomalonate","Glycolaldehyde","Glyoxylate","Glycolate")
