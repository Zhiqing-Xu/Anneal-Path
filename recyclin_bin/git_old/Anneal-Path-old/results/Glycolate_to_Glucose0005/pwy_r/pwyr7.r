...
DHE0003 <- DirectedHyperedge(c("Glyceraldehyde"), c("Glycolaldehyde","Aldehyde"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Xylose","Aldehyde","Glycolaldehyde","Glyceraldehyde","Glyoxylate","O=C(CO)OP(=O)(O)O","Glycolate")
