...
DHE0003 <- DirectedHyperedge(c("O=CC(O)(O)C(=O)C(=O)O"), c("Oxomalonate","Aldehyde"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glyoxylate"), c("O=CC(O)(O)C(=O)C(=O)O"), "EC4.1.2_3")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Xylose","Aldehyde","D-Threose","Glyoxylate","O=CC(O)(O)C(=O)C(=O)O","Oxomalonate","Glycolaldehyde","Glycolate")
