...
DHE0003 <- DirectedHyperedge(c("NC(O)(CO)C(O)C=O"), c("Aldehyde","NC(O)C(O)C=O"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glycolaldehyde"), c("D-Threose"), "EC4.1.2_3")
DHE0005 <- DirectedHyperedge(c("NC(=O)CO","Glycolaldehyde"), c("NC(O)(CO)C(O)C=O"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Xylose","Aldehyde","D-Threose","Glyoxylate","NC(O)(CO)C(O)C=O","NC(O)C(O)C=O","Glycolaldehyde","NC(=O)CO","Glycolate")
