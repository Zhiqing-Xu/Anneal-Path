...
DHE0003 <- DirectedHyperedge(c("O=CC(O)C(O)(O)C=O"), c("Aldehyde","2-Hydroxy-3-oxopropanoate"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("O=CC(O)C(O)(O)C=O"), "EC4.1.2_3")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Xylose","Aldehyde","D-Threose","Glyoxylate","O=CC(O)C(O)(O)C=O","2-Hydroxy-3-oxopropanoate","Glycolaldehyde","Glycolate")
