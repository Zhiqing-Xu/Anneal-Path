...
DHE0003 <- DirectedHyperedge(c("O=CC(O)C(=O)COC(=O)CO"), c("Aldehyde","O=CC(=O)COC(=O)CO"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("O=C(O)COC(=O)CO","Glycolaldehyde"), c("O=CC(O)C(=O)COC(=O)CO"), "EC3.7.1_0")
DHE0005 <- DirectedHyperedge(c("Glycolaldehyde"), c("D-Threose"), "EC4.1.2_3")
DHE0006 <- DirectedHyperedge(c("Glycolaldehyde"), c("Aldehyde","Glyoxylate"), "EC4.1.2_4")
DHE0007 <- DirectedHyperedge(c("Glycolate"), c("O=C(O)COC(=O)CO"), "EC3.1.1_0")
DHE0008 <- DirectedHyperedge(c("Glycolate"), c("Glycolaldehyde"), "EC1.2.1_0")
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Xylose","Aldehyde","D-Threose","Glyoxylate","O=CC(O)C(=O)COC(=O)CO","O=CC(=O)COC(=O)CO","O=C(O)COC(=O)CO","Glycolaldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","9.png",sep="")
