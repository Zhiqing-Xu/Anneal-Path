...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","3-Dehydro-L-threonate","Hydroxypyruvate","D-Threose","Aldehyde","Glycolaldehyde","NC(=O)CO","Formamide","Glycolate")
