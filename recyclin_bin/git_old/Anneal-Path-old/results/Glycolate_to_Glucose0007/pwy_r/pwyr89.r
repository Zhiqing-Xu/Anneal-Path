...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glycolaldehyde","Aldehyde","Glyceraldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","89.png",sep="")
