...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glycolaldehyde","Aldehyde","D-Threose","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","85.png",sep="")
