...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","2-Hydroxy-3-oxopropanoate","D-Threose","Glycolaldehyde","Aldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","100.png",sep="")
