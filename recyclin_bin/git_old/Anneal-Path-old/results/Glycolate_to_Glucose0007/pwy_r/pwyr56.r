...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glycolate","D-Threose","Glycolaldehyde","Aldehyde")
...
save_path<-paste(other.name,"/pathways/pathway","56.png",sep="")
