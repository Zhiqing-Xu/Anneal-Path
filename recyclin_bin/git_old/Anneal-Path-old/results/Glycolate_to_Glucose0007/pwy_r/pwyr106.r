...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Hydroxypyruvate","Aldehyde","Glycolaldehyde","Glyceraldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","106.png",sep="")
