...
DHE0005 <- DirectedHyperedge(c("Glyoxylate"), c("Oxomalonate"), "EC4.1.2_2")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Oxomalonate","HCO3-","D-Threose","Glycolate","Glycolaldehyde")
