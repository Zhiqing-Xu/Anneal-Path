...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Hydroxypyruvate","Aldehyde","D-Threose","Glycolate","Glycolaldehyde")
...
save_path<-paste(other.name,"/pathways/pathway","107.png",sep="")
