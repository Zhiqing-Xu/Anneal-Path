...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glycolate","D-Threose","Aldehyde","Glycolaldehyde")
...
save_path<-paste(other.name,"/pathways/pathway","52.png",sep="")
