...
DHE0006 <- DirectedHyperedge(c("Glycolate","Glycolaldehyde"), c("O=CC(O)C(O)(O)CO"), "EC4.1.2_5")
DHE0007 <- DirectedHyperedge(c("Glycolate"), c("Glycolaldehyde"), "EC1.2.1_0")
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","O=CC(O)C(O)(O)CO","O=CC(O)(O)CO","D-Threose","Glycolaldehyde","Aldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","116.png",sep="")
