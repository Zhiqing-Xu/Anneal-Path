...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Xylose","Aldehyde","D-Threose","D-Erythrulose","Glyceraldehyde","Glycolaldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","117.png",sep="")
