...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glycolate","Glycolaldehyde","Glyceraldehyde")
...
save_path<-paste(other.name,"/pathways/pathway","54.png",sep="")
