...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","2-Hydroxy-3-oxopropanoate","Aldehyde","Glycolaldehyde","Glyceraldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","22.png",sep="")
