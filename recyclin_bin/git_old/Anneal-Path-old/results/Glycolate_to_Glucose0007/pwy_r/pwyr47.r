...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Aldehyde","D-Threose","Glycolaldehyde","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","47.png",sep="")
