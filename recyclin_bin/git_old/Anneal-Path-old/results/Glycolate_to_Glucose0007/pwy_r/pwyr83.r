...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glycolaldehyde","Aldehyde","D-Threose","NC(=O)CO","Formamide","Glycolate")
...
save_path<-paste(other.name,"/pathways/pathway","83.png",sep="")
