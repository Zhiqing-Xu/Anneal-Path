...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Glycolaldehyde","Aldehyde","D-Threose","Glycolate","O=C(CO)OP(=O)(O)O")
...
save_path<-paste(other.name,"/pathways/pathway","90.png",sep="")
