...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","Glyoxylate","D-Xylose","Aldehyde","D-Threose","Glycolate","Glycolaldehyde")
...
save_path<-paste(other.name,"/pathways/pathway","46.png",sep="")
