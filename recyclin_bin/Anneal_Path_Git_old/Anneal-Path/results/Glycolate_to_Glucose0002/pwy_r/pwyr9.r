...
DHE0002 <- DirectedHyperedge(c("O=C(O)C(=O)C(O)CO"), c("Oxomalonate","Glycolaldehyde"), "EC4.1.2_1")
DHE0003 <- DirectedHyperedge(c("Glyceraldehyde","Aldehyde"), c("D-Threose"), "EC4.1.2_2")
DHE0004 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("Glyceraldehyde"), "EC4.1.2_3")
DHE0005 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("O=C(O)C(=O)C(O)CO"), "EC4.1.2_4")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","O=C(O)C(=O)C(O)CO","Oxomalonate","Glyceraldehyde","Aldehyde","Glyoxylate","NC(=O)CO","Formamide","Glycolate")
