...
DHE0004 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("O=C(O)C(=O)C(O)CO"), "EC4.1.2_3")
...
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","O=C(O)C(=O)C(O)CO","Oxomalonate","Glyoxylate","Glycolate")
