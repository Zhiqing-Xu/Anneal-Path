...
DHE0003 <- DirectedHyperedge(c("Glyceraldehyde","Glyoxylate"), c("D-Threose"), "EC4.1.2_1")
DHE0004 <- DirectedHyperedge(c("Glyoxylate"), c("2-Oxoaldehyde"), "EC1.2.1_0")
DHE0005 <- DirectedHyperedge(c("Glycolate"), c("Glyoxylate"), "EC1.1.1_2")
DHE0006 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("Glyceraldehyde"), "EC4.1.2_2")
DHE0007 <- DirectedHyperedge(c("Glycolate"), c("Glycolaldehyde"), "EC1.2.1_1")
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","2-Oxoaldehyde","Glyceraldehyde","Glyoxylate","Glycolate")
