...
DHE0006 <- DirectedHyperedge(c("Glyoxylate","Glycolaldehyde"), c("O=C(O)C(=O)C(O)CO"), "EC4.1.2_4")
DHE0007 <- DirectedHyperedge(c("Glycolate"), c("Glycolaldehyde"), "EC1.2.1_0")
Cnodes <- c("O=CC(O)C(O)C(O)C(O)CO","D-Glucose","D-Threose","Glycolaldehyde","O=C(O)C(=O)C(O)CO","Oxomalonate","Glyceraldehyde","Glyoxylate","Glycolate")
