...
#-------------------------------##-------------------------------#
'''
def remove_hydrogen_nodes_in_rule_bk(one_ruleH):
    while (one_ruleH.find('[H]')!=-1):
        location=one_ruleH.index('[H]')
        one_ruleH=replace_n(one_ruleH,location,'') # Remove '['
        one_ruleH=replace_n(one_ruleH,location,'') # Remove 'H'
    ...
    while (one_ruleH.find('[H:')!=-1):
        ...
        if one_ruleH[location+4]=="]":
            ...
            one_ruleH=replace_n(one_ruleH,location,'') # Remove '*'
            one_ruleH=replace_n(one_ruleH,location,'') # Remove ']'
            if one_ruleH[location]=="/" or one_ruleH[location]=="\\":
                one_ruleH=replace_n(one_ruleH,location,'')
            if one_ruleH[location-1]=="/" or one_ruleH[location-1]=="\\":
                one_ruleH=replace_n(one_ruleH,location-1,'')
        elif one_ruleH[location+5]=="]":
            one_ruleH=replace_n(one_ruleH,location,'') # Remove '['
            one_ruleH=replace_n(one_ruleH,location,'') # Remove 'H'
            one_ruleH=replace_n(one_ruleH,location,'') # Remove ':'
